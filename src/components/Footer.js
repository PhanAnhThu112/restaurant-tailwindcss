...
const Footer = () => {
  ...
  return (
    <footer
      className="relative top-96 z-20 bg-dark 
    lg:bg-transparent lg:min-h-[620px] lg:bg-footer lg:bg-center lg:bg-no-repeat pt-20"
    >
      <div className="container mx-auto h-full">
        ...
        whileInView={'show'}
         className="h-full flex flex-col gap-y-4">
          ...
          lg:gap-x-[130px] gap-y-12 lg:gap-y-0 lg:mb-12">
